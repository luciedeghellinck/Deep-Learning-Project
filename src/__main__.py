...
def create_selection_methods(dataset_train, dataset_validate, mu_values) -> th.Tensor:
    ...
    selection_methods = th.tensor([IPW(tau_models, dataset_validate, propensity_regressor),
...
def main():
    ...
    for i, (dataset_train, dataset_validate, mu_values, dataset_test) in enumerate(dataset):
        selection_methods = create_selection_methods(dataset_train,
                                                     dataset_validate)  # Tensor: [IPW, TauRisk, PlugIn, CFCV]
